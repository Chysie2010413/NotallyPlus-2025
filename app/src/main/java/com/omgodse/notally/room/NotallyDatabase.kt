...
import com.notally.plus.room.dao.BaseNoteDao
import com.notally.plus.room.dao.CommonDao
import com.notally.plus.room.dao.LabelDao
...
abstract class NotallyDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * allowMainThreadQueries() is only used in [com.notally.plus.ReminderReceiver.onReceive]
